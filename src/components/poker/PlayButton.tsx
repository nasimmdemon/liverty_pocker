...
const PlayButton = ({ onClick }: PlayButtonProps) => {
  return (
    <motion.button
      onClick={onClick}
      className="play-btn relative px-8 sm:px-12 md:px-16 py-4 sm:py-5 md:py-6 text-2xl sm:text-4xl md:text-5xl font-display tracking-wider uppercase rounded-xl sm:rounded-2xl cursor-pointer select-none"
      style={{
